...
from .views import TweetLists, my_feed, retweet_api, tweet_create_api, tweet_delete_api, tweet_detail_api, tweet_like_api, tweets_by_user, tweets_by_username

urlpatterns = [
    path('tweet/', TweetLists.as_view()),
